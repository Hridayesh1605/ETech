...
const ChapterModal = () => {
    ...
    const chapter: Chapter | undefined = selectedChapterIndex !== null && selectedSectionIndex !== null ? sections[selectedSectionIndex].chapters[selectedChapterIndex]:undefined;
