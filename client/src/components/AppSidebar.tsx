...
const AppSidebar = () => {
    ...
    const navLinks = {
        ...
        teacher:[
            { icon:BookOpen,label:"Courses",href:"/teache/courses"},
            { icon:DollarSign,label:"Billings",href:"/teache/billing"},
            { icon:User,label:"Profile",href:"/teache/profile"},
            { icon:Settings,label:"Settings",href:"/teache/settings"},
                    ...
                    >
                        <div className="app-sidebar__logo-container group">
                            <div className="app-sidebar__logo-wrapper">
                                ...
                                <p className="app-sidebar__title">ETech</p>
        ...
        <SidebarContent>
            <SidebarMenu className='app-sidebar__nav-menu'>
                {currentNavLinks.map((link) => {
                    ...
                    return(
                        <SidebarMenuItem key={link.href} className={cn("app-sidebar__nav-items",
