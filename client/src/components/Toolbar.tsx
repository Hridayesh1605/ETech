...
const Toolbar = ({onSearch,onCategoryChange}:ToolbarProps) => {
  ...
  return (
    <div className='toolbar'>
        <input type="text" value={searchTerm} onChange={(e)=>handleSearch(e.target.value)} placeholder='Search Courses' className='toolbar__search' />
            ...
            <SelectContent className='bg-customgreys-primarybg hover:bg-customgreys-primarybg'>
                ...
                </SelectItem>
                {
                    courseCategories.map((category)=>(
                        ...
                        value={category.value} className='toolbar__select-item'>
                            {category.label}
                        </SelectItem>
                    ))
                }
