...
export const getUserEnrolledCourses = async (
  ...
  export const getUserCourseProgress = async (
    ...
    try {
      ...
      res.json({
        message: "Cource progress retrieved successfully",
        data: progress,
      });
    } catch (error) {
      res
        .status(500)
        .json({ message: "Cource progress retrieved unsuccessfully", error });
    }
  };
  ...
  export const updateUserCourseProgress = async (
    ...
    try {
      ...
      res
        .status(500)
        .json({ message: "Error updating user progress", error });
    }
  };